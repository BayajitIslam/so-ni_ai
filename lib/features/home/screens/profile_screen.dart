...
import 'package:template/features/splash/widgets/profile_card.dart';
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            SizedBox(height: 8.h),
            //Gender
            ProfileCard(title: "Male", topTitle: "Gender"),
            //Age
            ProfileCard(title: "32 Years Old", topTitle: "Age"),
            //Height
            ProfileCard(title: "180 cm", topTitle: "Height"),
            //Weight
            ProfileCard(title: "75 Kg", topTitle: "Weight"),
            ...
            SizedBox(height: 8.h),
            // Goal
            ProfileCard(title: "Weight loss", topTitle: "Goal"),
            //Dietary  Restriction
            ...
            SizedBox(height: 8.h),
            //Language
            ProfileCard(title: "Language", topTitleDisable: true),

            //Notification
            ProfileCard(title: "Notification", topTitleDisable: true),
